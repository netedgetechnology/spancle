 ...
 * Tenant portal: /media
 *
 * Media Library main page. Two-panel layout:
 *   Left:  MediaGrid (browse, filter, paginate)
 *   Right: AssetDetails (when an asset is selected) | RegisterAssetForm (when adding)
 *
 * Upload status:
 *   Multipart upload is Sprint 3. Register-by-metadata is the current ingestion path.
 */
    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center justify-between gap-4 flex-shrink-0">
        <div>
          ...
          <p className="mt-0.5 text-xs text-gray-400">Images, videos, documents and other files</p>
        </div>
        <button
          type="button"
