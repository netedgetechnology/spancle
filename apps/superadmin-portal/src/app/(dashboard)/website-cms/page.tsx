...
export default function WebsiteCmsPage(): React.ReactElement {
  return (
    <div className="flex flex-col gap-6">
        ...
        {CMS_CARDS.map((card) => (
          ...
          >
            ...
            <div className="mt-auto pt-2">
              <span className="inline-flex items-center text-xs text-gray-400 cursor-not-allowed select-none">
                Edit {card.title.toLowerCase()}
                <svg className="ml-1 h-3 w-3" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" aria-hidden="true">
      ...
      <div className="rounded-xl border border-dashed border-gray-200 bg-gray-50 px-6 py-5">
        <p className="text-xs text-gray-400">
          <span className="font-medium text-gray-600">Sprint A complete.</span>{' '}
          Page editing, section management and SEO editing are coming in the next sprint.
        </p>
      </div>
    </div>
  );
