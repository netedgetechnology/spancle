...
const redis_event_bus_publisher_1 = require("./redis-event-bus.publisher");
...
exports.EventBusModule = EventBusModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [redis_event_bus_publisher_1.RedisEventBusPublisher],
        exports: [redis_event_bus_publisher_1.RedisEventBusPublisher],
    })
], EventBusModule);
