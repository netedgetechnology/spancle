...
let MenuRepository = class MenuRepository extends tenant_aware_repository_1.TenantAwareRepository {
    constructor(dataSource) {
        super(menu_entity_1.MenuEntity, dataSource.manager);
    }
    ...
    async isHandleTaken(handle, tenantId, excludeId) {
