...
// ── Monthly time-series for sparklines ────────────────────────────────────────
...
// ── Recent tenant (for table widget) ──────────────────────────────────────────
...
//
// NOTE: Derived from tenants.tier + tenants.status until a dedicated billing
// service adds a subscriptions schema. "Subscription" = active/trial tenant
// with a non-free tier. Clearly labelled isProxy: true in the response.
